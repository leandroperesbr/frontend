...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { altura: @pessoa.altura, data_de_nascimento: @pessoa.data_de_nascimento, date: @pessoa.date, nome: @pessoa.nome }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { altura: @pessoa.altura, data_de_nascimento: @pessoa.data_de_nascimento, date: @pessoa.date, nome: @pessoa.nome }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
